...
Theorem div_mod_correct: forall n m, 0 < m -> n = div n m * m + modn n m. 
...
Theorem mod_lt: forall n m, 0 < m -> modn n m < m. 
intros n m; case m; simpl; auto with arith.
...
intros n m p H0; apply lexico_mult with (b := p) (c1 := modn (p * m + n) p) (c2 := modn n p); 
